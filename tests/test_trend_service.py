...
def test_trend_service():
    ...
    all_sources = ["google", "news", "twitter"]
    print(f"Getting trends from all sources: {all_sources}")
    
    trends = trend_service.get_trending_topics(sources=all_sources, count=10)
    ...
    cached_trends = trend_service.get_trending_topics(sources=all_sources, count=10)
